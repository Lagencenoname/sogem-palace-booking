...
const ServicesSection = () => {
  ...
  const amenities = [{
    ...
    description: "Alimentation continue"
  }, {
    icon: <Building className="w-6 h-6" />,
    title: "Domiciliation",
    description: "Adresse d'entreprise"
  }];
      ...
      <div className="container mx-auto px-4">
          ...
          {services.map((service, index) => <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-0 shadow-lg">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  {service.pricing.map((price, idx) => <div key={idx} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1">
                    {service.features.map((feature, idx) => <li key={idx} className="text-sm text-gray-600 flex items-center">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {amenities.map((amenity, index) => <div key={index} className="flex items-start space-x-4 p-4 rounded-xl hover:bg-gray-50 transition-colors duration-300">
