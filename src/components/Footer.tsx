  ...
  return <footer className="bg-gray-900 text-white py-12 px-4 md:px-8">
      <div className="container mx-auto">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">SOGEM PALACE. © 2025  Tous droits réservés.<a href="https://kloo.me/noname" className="text-sogem-orange hover:underline">Découvrez comment.</a>
          </p>
        </div>
      </div>
    </footer>;
